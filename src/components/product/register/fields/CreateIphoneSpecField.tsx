...
export default function CreateIphoneSpecField({
  displaySize,
  ...
  const formatDisplayInfo = (specs: Spec[]) => {
    const info = specsToDisplayInfo(specs);
    return `${info.displaySize} / ${info.processor} / 가로: ${info.displayHorizontalPixel} X 세로: ${info.displayVerticalPixel} / ${info.displayBrightness}`;
  };
