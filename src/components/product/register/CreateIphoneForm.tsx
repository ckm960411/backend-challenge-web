...
import { CreateIphoneProductReqDto } from '@/api/product/dto/request/create-iphone-product.req.dto';
...
export default function CreateIphoneForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await ProductApi.createIphone(formData);
